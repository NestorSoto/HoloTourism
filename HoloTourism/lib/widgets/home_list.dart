...
class CustomList extends StatelessWidget {
  const CustomList(
      ...
      required this.touristicPlaces,
      required this.textNames})
      : super(key: key);

  final List<bool> selections;
  final List<File> touristicPlaces;
  //final List<String> textNames;
  final List<LugarModel> textNames;
  @override
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Primera(
                                  imagen: touristicPlaces[index],
                                  title: textNames[index])));
                    },
                    child: GridTile(
                        footer: Container(
                          ...
                          child: Text(textNames[index].nombre),
                        ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(textNames[index].nombre),
                    ),
                  );
                }),
          );
